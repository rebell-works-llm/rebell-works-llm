package com.rebellworksllm.backend.modules.matching.config;
...
public class AsyncConfig implements AsyncConfigurer {
    ...
    public Executor jobMatchingExecutor() {
        ...
        executor.setThreadNamePrefix("job-matching-async-");
...
//        executor.setRejectedExecutionHandler((r, e) -> logger.error("JobMatching thread pool exhausted: {}", e.getPoolSize()));
    ...
    public AsyncUncaughtExceptionHandler getAsyncUncaughtExceptionHandler() {
        return (throwable, method, params) -> logger.error("Uncaught async exception in method '{}', params={}, error={}",
